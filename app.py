"""
API bootstrap tweaks: renamed lifespan helper/logger, kept routing and responses intact
"""
import logging
...
async def general_exception_handler(request: Request, err: Exception):
    """Handle general exceptions"""
    app_logger.error(f"Unhandled exception: {err}", exc_info=True)
    return JSONResponse(
        ...
        content={
            "error": {
                ...
                "details": str(err) if settings.api_host == "0.0.0.0" else None,
            }
        },
    )
